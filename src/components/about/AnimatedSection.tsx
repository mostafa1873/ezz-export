        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((item, i) => (
            <motion.div
              ...
              // هنا التغيير: الـ State موجودة داخل المكون ده بس، فمش هتأثر على باقي الصفحة
            ...
            >
              ...
              <div className="absolute inset-0 w-full h-full">
                ...
                <Image
                  ...
                  className={`w-full h-full object-cover transition-transform duration-1000 ease-out transform-gpu will-change-transform ${openStep === i ? 'scale-110' : 'scale-100'}`}
                />
              </div>
