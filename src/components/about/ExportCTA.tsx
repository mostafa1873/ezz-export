...
export default function ExportCTA() {
  const t = useTranslations('About.ExportCTA');
    ...
    <section className="py-16 md:py-24 px-4 bg-white">
      <div className="max-w-5xl mx-auto">
        <div className="relative overflow-hidden bg-[#061a10] rounded-[2rem] md:rounded-[3.5rem] p-6 sm:p-10 md:p-16 shadow-2xl border border-emerald-900/30">
          ...
          <div className="absolute top-0 right-0 rtl:right-auto rtl:left-0 w-64 h-64 bg-[#2d5a27] rounded-full blur-[100px] opacity-20 -mr-32 -mt-32 rtl:-ml-32 rtl:mr-0" />

          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 md:gap-16">

            <div className="text-center lg:text-start space-y-4 md:space-y-6 flex-1">
            ...
            <div className="flex flex-col sm:flex-row lg:flex-col gap-4 w-full lg:w-auto">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                href="/catalog.pdf"
                className="flex items-center justify-between gap-6 p-4 md:p-5 bg-[#2d5a27] hover:bg-[#366d2f] text-white rounded-2xl md:rounded-3xl w-full transition-all shadow-lg shadow-black/20 group"
              >
                ...
                <ChevronRight size={20} className="text-white rtl:rotate-180" />
              </motion.a>
              ...
              <motion.a
                ...
                className="flex items-center justify-between gap-6 p-4 md:p-5 bg-emerald-950/40 hover:bg-emerald-900/50 border border-emerald-800/30 text-emerald-50 rounded-2xl md:rounded-3xl w-full transition-all shadow-xl backdrop-blur-md group"
              >
                <div className="flex items-center gap-4">
                ...
                <ChevronRight size={20} className="text-green-700 rtl:rotate-180" />
              </motion.a>
